        ...
        categories: [
            {
                title: 'נעים להכיר',
                img: niceToMeet,
                text: 'סורוקה - מרכז רפואי אוניברסיטאי על-שם משה סורוקה, הוא מרכז שלישוני, שבו יותר מ-1100 מיטות אשפוז. כבית חולים-על, מעניק המרכז הרפואי שירותים רפואיים ליותר ממיליון תושבים בנגב.עוד מידע על סורוקה תמצאו בכתבה המצורפת',
            ...
            },
            {
                title: 'עמדת מודיעין',
                img: info,
                text: 'אם ברצונכם להגיע למחלקה/יחידה ואינכם יודעים היכן היא נמצאת, תוכלו לפנות לעמדת המויעין על פי הקישור המצורף',
                link: 'https://hospitals.clalit.co.il/soroka/he/patients-Info/Pages/information.aspx'
            },
            {
                title: 'מחלקת ביטחון',
                img: security,
                text: 'מחלקת הביטחון עוסקת בשמירה על בטחונם של כל באי המרכז הרפואי סורוקה. לפירוט על תחומי הפעילות תוכלו ללחוץ על הקישור המצורף',
                link: 'https://hospitals.clalit.co.il/soroka/he/about/management/Pages/admin-security.aspx'
            },
            {
                title: 'מספרי טלפון שימושיים',
                img: phone,
                text: 'לשירתוכם, תמצאו בכתבה המצורפת מספרי טלפון חיוניים שיסייעו לכם בקבלת השירות הרצוי',
    ...
    },
    {
        ...
        categories: [
            ...
            },
            {
                title: 'גן רוגע',
                img: garden,
                text: 'מקום למאושפזים ולבני משפחותיהם להתרגעות, לשקט ולמנוחה',
    ...
    },
    {
        ...
        categories: [
            ...
            },
            {
                ...
                img: army,
                text: 'חיילים יקרים, לפני פנייתכם למיון, חשוב שתדעו מהם המקרים בהם את רשאים לפנות למיון ללא הפנייה מרופא צבאי ומהם המקרים בהם אתם מחוייבים בהפנייה. הכתבה המצורפת תעשה לכם סדר',
        ...
        categories: [
            {
                title: 'יד שרה',
                img: sarah,
                text: '​עמותת יד שרה מפעילה סניף במרכז הרפואי סורוקה, לטובת שירותי השאלת ציוד רפואי. אם הטיפול או השיקום שלכם מחייב קביים, כיסא גלגלים או עזרים אחרים, כאן תמצאו את המידע שיעזור לכם ',
                link: 'https://hospitals.clalit.co.il/soroka/he/patients-Info/Pages/yad-sara.aspx'
            },
            {
                title: 'כיסאות גלגלים להשאלה',
                img: wheelChair,
                text: 'ברחבי בית החולים מוצבות חמש תחנות עגינה שבהן כ-50 כסאות גלגלים להשאלה בכל שעות היממה. השירות אינו כרוך בתשלום ובתום השימוש עליכם להחזיר את הכיסאות לאחת מהתחנות. לחצו על הקישור לפרטים',
                link: 'https://hospitals.clalit.co.il/soroka/he/patients-Info/Pages/wheelchairs-for-borrowing.aspx'
            },
            {
                title: 'שירותי אינטרנט',
                img: internet,
                text: 'במרכז הרפואי סורוקה קיימת רשת תקשורת אלחוטית באצמעותה תוכלו לגלוש באינטרנט ללא תשלום. פרטים נוספים בכתבה המצורפת',
                link: 'https://hospitals.clalit.co.il/soroka/he/patients-Info/Pages/internet.aspx'
            },
            {
                title: 'השכרת מקלטי טלוויזיה',
                img: tv,
                text: 'בעת האשפוז במלחקה תוכלו ליהנות מצפייה במכשיר טלוויזיה שיותקן סמוך למיטתכם. השירות ניתן בתשלום. פלרטים נוספים לחצו על הקישור המצורף ',
        ...
        categories: [
            {
                title: 'בית כנסת',
                img: knesset,
                text: 'בית הכנסת בבית החולים פתוח לשימוש עובדי בית החולים, המטופלים והמבקרים בו. מידע על שעות פעילות וכן פעילויות נוספות המתקיימות בבית הכנסת, תוכלו למצוא בקישור הבא',
                link: 'https://hospitals.clalit.co.il/soroka/he/about/management/Pages/admin-religserv-synagogue.aspx'
            },
            {
                title: 'מחלקת דת וכשרות',
                img: kosher,
                text: 'המחלקה לדת ולכשרות בבית החולים מטפלת בנושאים רבים הקשורים בשמירה על חוקי הכשרות ומנהגי חג ושבת. בכתבה המצורפת תוכלו לקרוא על מגוון תחומי הטיפול של היחידה',
                link: 'https://hospitals.clalit.co.il/soroka/he/about/management/Pages/admin-religserv.aspx'
            },
            {
                title: 'חדר תפילה לציבור המוסלמי',
                img: islam,
                text: 'לרשות הציבור המוסלמי קיים בבית החולים חדר תפילה. לפרטים, לחצו על הקישור המצורף',
